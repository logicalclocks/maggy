...
from maggy.core.experiment_driver.no_spark_driver import NoSparkDriver
...
class NoSparkOptimizationDriver(NoSparkDriver):
    ...
    def _init_controller(
        ...
        if isinstance(optimizer, str):
            try:
                return NoSparkOptimizationDriver.controller_dict[optimizer.lower()]()
